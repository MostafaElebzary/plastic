                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-12 col-form-label">اسم الطبيب</label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-4 col-form-label">التخصص</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" value="{{$data->content}}" name="content" required>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-12 col-form-label">اسم الطبيب انجليزي</label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-4 col-form-label">التخصص انجليزي</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" value="{{$data->content_en}}" name="content_en" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control" type="number" value="{{ $data->item_code }}"
                                                       name="item_code" required>

                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-12 col-form-label">كلمة المرور</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="number" value="{{ $data->pass }}" name="pass" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-4 col-form-label">الرقم السري الجديد</label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-4 col-form-label">الوصف </label>
                                            <div class="col-sm-12">
                                                <textarea id="textarea" class="form-control summernote" name="desc" required>{{$data->desc}}</textarea>
...
{{--                                        <div class="form-group">--}}
{{--                                            <label for="example-text-input" class="col-sm-12 col-form-label">اسم الطبيب الانجليزي</label>--}}
{{--                                            <div class="col-sm-12">--}}
...
{{--                                        <div class="form-group">--}}
{{--                                            <label for="example-text-input" class="col-sm-4 col-form-label">التخصص الانجليزي</label>--}}
{{--                                            <div class="col-sm-12">--}}
{{--                                                <input class="form-control" type="text" value="{{$data->content_en}}" name="content_en" required>--}}
...
{{--                                        <div class="form-group">--}}
{{--                                            <label for="example-text-input" class="col-sm-4 col-form-label">الوصف الانجليزى</label>--}}
{{--                                            <div class="col-sm-12">--}}
{{--                                                <textarea id="textarea" class="form-control summernote" name="desc_en" required>{{$data->desc_en}}</textarea>--}}
