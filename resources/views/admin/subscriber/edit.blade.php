        ...
        <div class="container-fluid" dir="rtl">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.edit_subscriber.submit') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">رقم الهاتف 1</label>
                                    <div class="col-sm-12">
                                        <input class="form-control" type="tel" value="{{ $data->phone }}" name="phone" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">رقم الهاتف 2</label>
                                    <div class="col-sm-12">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">رقم العميل</label>
                                    <div class="col-sm-12">
                                        <input class="form-control" type="number" value="{{ $data->item_code }}" name="item_code" required>
                                    </div>
                                </div>
                                <div class="form-group">
