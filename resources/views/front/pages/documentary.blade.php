            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="white-bg p-md-5 p-3 d-inline-block">
                        <h1 class="text-theme">{{trans('lang.documentary')}} <span class="text-black"></span></h1>
                        <nav aria-label="breadcrumb" class="page-breadcrumb border-top border-light pt-3 mt-3">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{trans('lang.documentary')}}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="owl-carousel no-pb popup-gallery" data-dots="false" data-items="5" data-md-items="3" data-sm-items="2" data-xs-items="1" data-margin="10">
                           @foreach($documentary as $gallery)
                            <div class="item">
                                <div class="cases-item position-relative overflow-hidden">
                                    ...
                                    <div class=""> <span>{{$gallery->append_title}}</span>
