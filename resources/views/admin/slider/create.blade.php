                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" value="{{ old('title2') }}" name="title2" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" value="{{ old('title1_en') }}" name="title1_en" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" value="{{ old('title2_en') }}" name="title2_en" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="number" value="{{ old('sort') }}" name="sort" required>
                                    </div>
                                </div>
