        ...
        <div class="container-fluid" dir="rtl">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.create_documentary.submit') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" value="{{ old('title_en') }}" name="title_en" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea id="textarea" class="form-control summernote" name="content_en" required>{!! old('content_en') !!}</textarea>
                                            </div>
                                        </div>
