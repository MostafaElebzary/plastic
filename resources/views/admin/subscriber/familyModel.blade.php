...
<form action="{{ route('admin.edit_family.submit') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input class="form-control" type="text" value="{{$family->name}}" name="name" required>
                    <input class="form-control" type="hidden" value="{{$family->id}}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input class="form-control" type="text" value="{{$family->address}}"
            ...
            <div class="form-group">
                <label for="example-text-input" class="col-sm-12 col-form-label">درجة
                    القرابة</label>
                <div class="col-sm-12">
                    <input class="form-control" type="text" value="{{$family->relation}}"
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                <label for="example-text-input" class="col-sm-12 col-form-label">رقم الهاتف
                    1</label>
                <div class="col-sm-12">
                    <input class="form-control" type="tel" value="{{$family->phone}}" name="phone">
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="example-text-input" class="col-sm-12 col-form-label">رقم الهاتف
                    2</label>
                <div class="col-sm-12">
                    <input class="form-control" type="tel" value="{{$family->phone2}}" name="phone2">
                </div>
            </div>
            <div class="form-group">
                <label for="example-text-input" class="col-sm-12 col-form-label"> العمر</label>
                <div class="col-sm-12">
                    <input class="form-control" type="number" value="{{$family->age}}" name="age">
                </div>
            </div>
