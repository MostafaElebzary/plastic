...
@section('css')
    ...
    <link rel="stylesheet" type="text/css" href="{{url('public/old_front/multiple/jquery.dropdown.css') }}">
@endsection

@section('breadcrumb')
    <h3 class="page-title">رفع مجموعة عملاء</h1>
        @endsection
        ...
        @section('script-bottom')
            <script type="text/javascript"
                    src="{{url('public/old_front/multiple/mock.js') }}"></script>

            <script type="text/javascript"
                    src="{{url('public/old_front/multiple/jquery.dropdown.js') }}"></script>
            <script>
