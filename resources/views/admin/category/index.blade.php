        ...
        <div class="container-fluid" dir="rtl">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <div class="m-b-30">
                        <a href="{{ url('/admin/create_category/') }}" class="btn btn-purple waves-effect waves-light" data-toggle="modal" data-target="#addModel" role="button">اضف جديد</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        ...
                                        @endforeach
                                    @endif --}}
                                    @foreach ($row->childrens as $item=>$row3)
                                        {{$row3->name}}
                                    @endforeach
