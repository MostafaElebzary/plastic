                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#company" role="tab">بيانات العميل</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#wallet" role="tab">نتائج التحليل</a>
                                </li>
                            </ul>
                                            ...
                                            <div class="profile-widget text-center">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <td class="text-left"><strong>العمر :</strong></td>
                                                ...
                                                <div class="m-b-10">
                                                    <a href="{{ url('/admin/edit_subscriber/'.$data->id) }}"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="m-b-10">
                                                <a href="#" class="btn btn-purple waves-effect waves-light" data-toggle="modal"
                                                   data-target="#addAnalysisModel" role="button">اضف جديد</a>
                                            </div>
                                            <div class="table-responsive">
                                                <table class="table">
                                                    <thead>
                                                    ...
                                                    <tbody>
                                                    @foreach(\App\Models\ClientAnalysis::where('subscriber_id',$data->id)->get() as $item=> $row)
                                                        <tr>
                                                            <td>{{$item+1}}</td>
                                                            <td>
                                                                <a href="{{url('public/uploads/'.$row->file)}}" target="_blank"
                                                                   class="btn btn-primary"> <i class="fa fa-eye"></i> عرض</a>
                                                            </td>
                                                            <td>{{$row->created_at}}</td>
                                                            <td>
                                                                <a href="#" id="btn_analysis_delete" data-id="{{$row->id}}"
