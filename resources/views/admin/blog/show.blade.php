						...
						<div class="col-sm-8">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td class="text-left"><strong>العنوان انجليزي :</strong></td>
                                        <td class="text-center"><?php echo $data->title_en ; ?></td>
                                   </tr>
                                    <tr>
                                        <td class="text-left"><strong>المحتوى انجليزي :</strong></td>
                                        <td class="text-center"><?php echo $data->content_en ; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="p-2">
                                                <a href="{{ url(LaravelLocalization::getCurrentLocale().'/admin/edit_blog/'.$data->id) }}" class="btn btn-outline-purple waves-effect waves-light">تعديل الحساب</a>
                                            </div></td>
