        ...
        <div class="container-fluid" dir="rtl">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.create_subscriber.submit') }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="tel" value="{{ old('phone2') }}" name="phone2">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">العمر </label>
                                    <div class="col-sm-12">
                                        <input class="form-control" type="number" value="{{ old('age') }}" name="age" >
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="number" value="{{ $data }}"
                                               name="item_code" readonly>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">الرقم السري</label>
                                    <div class="col-sm-12">
