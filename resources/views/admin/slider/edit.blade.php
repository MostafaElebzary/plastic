...
@section('breadcrumb')
<h1 class="page-title">السلايدر</h1>
@endsection
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" value="{{ $data->title1 }}" name="title1" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" value="{{ $data->title2 }}" name="title2" required>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">عنوان 1 انجليزي</label>
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" value="{{ $data->title1_en }}" name="title1_en" required>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">عنوان 2 انجليزي</label>
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" value="{{ $data->title2_en }}" name="title2_en" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="number" value="{{ $data->sort }}" name="sort" required>
                                    </div>
                                </div>
