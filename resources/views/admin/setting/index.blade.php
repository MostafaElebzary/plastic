                ...
                <div class="container-fluid" dir="rtl">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <div class="m-b-30">
                                <a href="{{ url(LaravelLocalization::getCurrentLocale().'/admin/create_setting/') }}"
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" cellspacing="0"
                                ...
                                @foreach ($data as $item=>$row)
                                    <tr>
                                            ...
                                            @if($row->id != 1)
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox"
                                                           value="{{$row->id}}" name="check_delete{}"
                                                           id="customControlInline{{$item+1}}">
                                        ...
                                        <td>
                                            <a href="{{ url(LaravelLocalization::getCurrentLocale().'/admin/show_setting/'.$row->id) }}"
                                               class="btn btn-purple btn-sm waves-effect waves-light"><i
                                                    class="ti-eye"></i></a>
                                            <a href="{{ url(LaravelLocalization::getCurrentLocale().'/admin/edit_setting/'.$row->id) }}"
