...
@section('breadcrumb')
<h3 class="page-title">التعاقدات</h1>
@endsection
        ...
        <div class="container-fluid" dir="rtl">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <div class="m-b-30">
                        <a href="javascript:void(#)" class="btn btn-purple waves-effect waves-light" data-toggle="modal" data-target="#addModel" role="button">اضف جديد</a>
