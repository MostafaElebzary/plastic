						...
						<div class="col-sm-8">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td class="text-left" style="width: 30%;"><strong>العنوان انجليزي :</strong></td>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="p-2">
                                                <a href="{{ url(LaravelLocalization::getCurrentLocale().'/admin/edit_post/'.$data->id) }}" class="btn btn-outline-purple waves-effect waves-light">تعديل البيانات</a>
                                            </div></td>
